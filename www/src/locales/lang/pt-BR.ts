...
const translation = {
  app: {
    cookie: {
      message: "Este site usa cookies para deixar sua experiência ainda mais doce. Ao continuar, você concorda com nossa <a data-bs-toggle='modal' data-bs-target='#policy_modal'>Política de Privacidade</a> e com os <a data-bs-toggle='modal' data-bs-target='#terms_modal'>Termos de Uso</a>.",
      reject: "Rejeitar",
      accept: "Aceitar"
    },
    error: {
      INVALID_PLAYER_LIMIT: "Limite de jogadores em sala não foi definido.",
      INVALID_PLAYER_LIMIT_MIN: "O limite mínimo de jogadores em sala é de 2 pessoas.",
      INVALID_PLAYER_LIMIT_MAX: "O limite máximo de jogadores em sala é de 50 pessoas.",
    ...
    splash_screen: {
      message: "<a target='_blank' data-bs-toggle='modal' data-bs-target='#terms_modal'>Termos de Uso</a> e <a target='_blank' data-bs-toggle='modal' data-bs-target='#policy_modal'>Política de Privacidade</a>"
    },
    update: {
